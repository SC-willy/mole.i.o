...
namespace Supercent.Util
{
    public static class ObjectUtil
    {
        ...
        //------------------------------------------------------------------------------
        public static T LoadAndInstantiate<T>(string path, Transform parent) where T : UnityObject
        {
            return LoadAndInstantiate<T>(path, parent, Vector3.zero, Vector3.one, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T LoadAndInstantiate<T>(string path, Transform parent, Vector3 pos) where T : UnityObject
        {
            return LoadAndInstantiate<T>(path, parent, pos, Vector3.one, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T LoadAndInstantiate<T>(string path, Transform parent, Vector3 pos, Vector3 scale) where T : UnityObject
        {
            return LoadAndInstantiate<T>(path, parent, pos, scale, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T LoadAndInstantiate<T>(string path, Transform parent, Vector3 pos, Vector3 scale, Quaternion rot) where T : UnityObject
        {
        ...
        // Generic
        //------------------------------------------------------------------------------
        public static T Instantiate<T>(GameObject prefab, Transform parent) where T : UnityObject
        {
            return Instantiate<T>(prefab, parent, Vector3.zero, Vector3.one, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T Instantiate<T>(GameObject prefab, Transform parent, Vector3 pos) where T : UnityObject
        {
            return Instantiate<T>(prefab, parent, pos, Vector3.one, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T Instantiate<T>(GameObject prefab, Transform parent, Vector3 pos, Vector3 scale) where T : UnityObject
        {
            return Instantiate<T>(prefab, parent, pos, scale, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T Instantiate<T>(GameObject prefab, Transform parent, Vector3 pos, Vector3 scale, Quaternion rot) where T : UnityObject
        {
        ...
        // MonoBehaviour
        //------------------------------------------------------------------------------
        public static T Instantiate<T>(MonoBehaviour prefab, Transform parent) where T : UnityObject
        {
            return Instantiate<T>(prefab, parent, Vector3.zero, Vector3.one, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T Instantiate<T>(MonoBehaviour prefab, Transform parent, Vector3 pos) where T : UnityObject
        {
            return Instantiate<T>(prefab, parent, pos, Vector3.one, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T Instantiate<T>(MonoBehaviour prefab, Transform parent, Vector3 pos, Vector3 scale) where T : UnityObject
        {
            return Instantiate<T>(prefab, parent, pos, scale, Quaternion.Euler(0f, 0f, 0f));
        }

        public static T Instantiate<T>(MonoBehaviour prefab, Transform parent, Vector3 pos, Vector3 scale, Quaternion rot) where T : UnityObject
        {
